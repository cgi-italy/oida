...
- add check for disposed instance in chart event unsubscription ([5a42f24](https://gitlab.dev.eoss-cloud.it/frontend/oida/commit/5a42f24e02a0cd4dda6cfd931e850e9cbb1ad888))

### Features

- allow disabling user dataset renaming ([16aa14b](https://gitlab.dev.eoss-cloud.it/frontend/oida/commit/16aa14b8e8f5ca53ac03b5910f9ceb100c319963))

...
import {
    isDomainProvider, NumericDomainMapper, DatasetRasterSequenceItem, RasterBandConfig
} from '@oida/eo-mobx';

import { ChartWidget } from '../chart-widget';


export type DatasetRasterSequenceItemHistogramProps = {
...
export const DatasetRasterSequenceItemHistogram = (props: DatasetRasterSequenceItemHistogramProps) => {

    const histogramData = props.item.stats?.histogram;
    if (!histogramData) {
        return null;
    }

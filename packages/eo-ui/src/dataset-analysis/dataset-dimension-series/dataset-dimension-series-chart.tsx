    ...
    const {chartSeries, colors} = useObserver(() => {
        ...
        props.series.forEach((series, idx) => {
            ...
            if (dimension === 'time') {
                ...
                dimensionConfig = series.config.dimensions?.find((d) => d.id === series.dimension);
            }
            ...
            if (!axes.x[dimensionConfig.id]) {
                ...
                if (dimensionConfig.id === 'time') {
                    ...
                    axisType = dimensionConfig.domain && isValueDomain(dimensionConfig.domain) ? 'value' : 'category';
                }

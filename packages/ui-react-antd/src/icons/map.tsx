...
export const SvgMap = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512' width='1em' height='1em' fill='currentColor' {...props}>
...
export const MapIcon = (props: any) => <Icon component={SvgMap} {...props} />;

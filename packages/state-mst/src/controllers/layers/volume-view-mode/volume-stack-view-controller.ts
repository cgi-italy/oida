...
import { IStackVolumeMode } from '../../../types/layers/volume-layer';
import { VolumeViewModeController } from './volume-view-mode-controller';

export class VolumeStackViewController extends VolumeViewModeController<StackVolumeView, IStackVolumeMode> {

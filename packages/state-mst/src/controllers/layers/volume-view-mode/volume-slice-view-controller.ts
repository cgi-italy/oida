...
import { ISliceVolumeMode } from '../../../types/layers/volume-layer';

import { VolumeViewModeController } from './volume-view-mode-controller';

export class VolumeSliceViewController extends VolumeViewModeController<SliceVolumeView, ISliceVolumeMode> {
